"""
PPO model evaluation script — loads from config/environment.yaml.

PPO is on-policy — no replay buffer is used.

Usage::

    python Evaluation/predict_model_ppo.py --episodes 10 --gui false --show false

    python Evaluation/predict_model_ppo.py \\
        --config config/environment.yaml \\
        --run Data/Training/PPO/FRAME_ONLY/run_xxx \\
        --episodes 10"""
import argparse
import sys
...
DEFAULT_RUN_DIR = PROJECT_ROOT / "Data" / "Training" / "PPO" / "FRAME_ONLY"
