"""
SAC (Soft Actor-Critic) training entry point.

Loads config/environment.yaml and trains a SAC model on the Cartesian path planning task.
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Train SAC on Cartesian Path Planning",
    )
    parser.add_argument(
        "--config",
        type=Path,
