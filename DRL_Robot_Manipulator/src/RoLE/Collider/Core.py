...
"""
RoLE Collider — AABB and OBB Collision Detection
================================================
Axis-Aligned Bounding Box (AABB) and Oriented Bounding Box (OBB) classes
for 3D collision detection between robot links and external objects.

Supports: point containment, ray/line segment intersection, and OBB-OBB
overlap via the Separating Axis Theorem (SAT).
...
References:
    ...
    4. Essential Mathematics for Game and Interactive Applications, James M. VanVerth and Lars M. Bishop

Supported tests:
    A. Shape intersection: AABB-AABB, OBB-OBB, OBB-AABB
    B. Raycast: Line Segment vs AABB, Line Segment vs OBB
    C. Point containment: Point Inside AABB, Point Inside OBB
"""
