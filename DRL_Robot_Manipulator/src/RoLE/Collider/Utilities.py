...
======================
Helpers for 3D collision detection: AABB computation and floating-point comparison
with relative epsilon tolerance.

Used by the RoLE collision detection layer.
"""
