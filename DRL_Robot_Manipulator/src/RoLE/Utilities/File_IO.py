"""
RoLE Utilities — File I/O
=========================
Simple file read/write utilities for training results: pickle (binary) and text formats.

Used by training scripts to persist elapsed time logs and by evaluation scripts
to read/write prediction trajectories and episode metrics.
"""
