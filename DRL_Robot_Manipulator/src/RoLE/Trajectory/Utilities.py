"""
RoLE Trajectory Utilities — Linear and Trapezoidal Profiles
=======================================================
One-dimensional trajectory generators: constant-velocity linear profile,
trapezoidal velocity-profile (with blend phases), and quintic polynomial profile.

Used by the PyBullet robot control layer for smooth joint motion between waypoints.
"""
