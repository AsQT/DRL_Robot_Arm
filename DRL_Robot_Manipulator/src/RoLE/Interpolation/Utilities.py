...
==========================
Shared helpers for curve interpolation: linear and spherical linear interpolation
(LERP, SLERP), Bernstein and B-spline basis functions, Ramer-Douglas-Peucker
curve simplification, and knot vector generation (uniform, chord-length, centripetal).
"""
