"""
RoLE Bezier Curve Interpolation
============================
Arbitrary-degree Bezier curve generation from control points.
Supports explicit and polynomial evaluation modes, arc-length computation,
RDP simplification, derivative curves, and bounding box estimation.
"""
