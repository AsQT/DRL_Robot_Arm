"""
RoLE B-Spline Curve Interpolation
================================
B-spline curve generation with configurable polynomial degree and knot vector.
Supports uniform, chord-length, and centripetal knot parameterisation, least-squares
control-point optimisation, RDP simplification, and derivative curves via De Boor's algorithm.
"""
...
import RoLE.Interpolation.Utilities as Utilities
