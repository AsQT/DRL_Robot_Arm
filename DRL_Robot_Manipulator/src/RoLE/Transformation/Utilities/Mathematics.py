...
========================================
Core mathematical primitives for robotics: vector norms, solving linear/quadratic
polynomials, eigenvalue-free polynomial root finding, and geometric utilities.

Used throughout the RoLE kinematics and transformation layers.
"""
