"""
RoLE Geometric Primitives
========================
Lightweight 3D geometric primitives: ``Point_Cls``, ``Line_Segment_Cls``, and
``Box_Cls`` with homogeneous transformation support.

Used throughout RoLE for collision detection, configuration space representation,
and general geometry operations.
"""
