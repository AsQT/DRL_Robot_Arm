...
"""
PyBullet Utility Functions
==========================
Helpers for PyBullet-based robot simulation: wireframe visualisation,
environment structure lookup, and joint configuration lookup.
"""
