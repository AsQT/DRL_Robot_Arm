"""
Static-target prediction script for TD3.
...
Edit USER CONFIG below to set the model path, then run:
    python Evaluation/Gym/Model/Prediction/Static/predict_td3.py
"""
# =============================================================================
...
CONST_MODEL_PATH = r"Data/Training/Environment_Default/TD3/YASKAWA_GP7/run_20260505_010923/model/final_model.zip"
...
def main():
    ...
    model = TD3.load(str(model_zip), device=DEVICE)
