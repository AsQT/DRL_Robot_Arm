...
Trains a DDPG agent on the YaskawaGP7ReachPyBullet Collision-Free environment,
...
# from both "python Training/train_ddpg.py" and "cd Training && python train_ddpg.py".
...
Notes:
    ...
    $ cd Training && python train_ddpg.py
"""
